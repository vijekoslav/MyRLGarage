...
public class PresetReverseAlphabeticalAdapter extends FirestoreRecyclerAdapter<Preset, PresetReverseAlphabeticalAdapter.PresetViewHolder> {

    Context context;

    public PresetReverseAlphabeticalAdapter(@NonNull FirestoreRecyclerOptions<Preset> options, Context context) {
        super(options);
