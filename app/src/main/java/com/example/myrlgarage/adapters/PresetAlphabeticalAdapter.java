...
public class PresetAlphabeticalAdapter extends FirestoreRecyclerAdapter<Preset, PresetAlphabeticalAdapter.PresetViewHolder> {

    Context context;

    public PresetAlphabeticalAdapter(@NonNull FirestoreRecyclerOptions<Preset> options, Context context) {
        super(options);
