...
public class PresetAdapter extends FirestoreRecyclerAdapter<Preset, PresetAdapter.PresetViewHolder> {

    Context context;

    public PresetAdapter(@NonNull FirestoreRecyclerOptions<Preset> options, Context context) {
        super(options);
